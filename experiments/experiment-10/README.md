...
**2026-03-18 (run 1):** Succeeded during interactive session, results matched Experiment 3 exactly. Output not captured to log.

**2026-03-18 (run 2):** Re-run to capture logs failed — `try-layer1.starforge.app` became unresponsive (HTTP 504).

**2026-03-18 (run 3):** Service recovered. Full successful run captured in `run-output-20260318.log`. Results identical to Experiment 3 (same non-commutativity, same orphaned properties on branch-uv).
