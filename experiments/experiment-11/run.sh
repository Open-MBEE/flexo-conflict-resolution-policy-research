...
#   local Flexo instance (Experiment 4) when OWL ontology and SHACL shapes
#   are loaded alongside instance data?
#
# Data files imported from experiment-4:
#   ancestor-model.ttl, ontology.ttl, shapes.ttl,
#   commit-u-remove-bg.ru, commit-v-enrich-bg.ru,
#   oracle/*.rq (c1-c6) — all identical, linked via symlinks.
...
ORG="research"
REPO="mtg-kc-remote-schema-$(date +%s)"
TIMEOUT=60
...
echo "  Compare with Experiment 4 (local)."
